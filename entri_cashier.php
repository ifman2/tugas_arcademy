...
<body>
	<div class="container">
		<h1>Entri Cashier</h1><br>
<form method="post" action="">
	  <div class="form-group row">
	    <label class="col-sm-2 col-form-label">Nama Cashier</label>
	    	<div class="col-sm-5">
	      		<input type="text" name="nama_cashier"  class="form-control" id="inputcategory"  required="">
	    	</div>
	  </div>
  ...
  <div class="form-group row">
	...
	<?php
		if (isset($_POST['simpan'])){
		  ...
		  $q=mysqli_query($db, "INSERT INTO cashier(name)VALUES('$_POST[nama_cashier]')");
		  if ($q)
		    echo ("<SCRIPT>
